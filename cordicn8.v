...
//===================================================================================================================
module cordicn8(a,b,c,clk,rst,vr,o1,o2,o3,lcont);
//module report(clk,rst,vr,o1,o2,o3,lcont,x1,y1,zz1,x2,y2,zz21,x3,y3,zz31,x4,y4,zz41,x5,y5,zz51,x6,y6,zz61,x7,y7,zz71);
input[31:0]a,b,c;
input vr;
assign selvr=vr;
...
//output[31:0]x1,y1,zz1,x2,y2,zz21,x3,y3,zz31,x4,y4,zz41,x5,y5,zz51,x6,y6,zz61,x7,y7,zz71;
wire zd1;
//==========================================================================
...
output lcont;
assign lcont=frc8|frc7|frc6|frc5|frc4|frc3|frc2|frc1;
mux032 fin1(32'b00000000000000000000000000000000,x8,~lcont,o1);
mux032 fin2(32'b00000000000000000000000000000000,y8,~lcont,o2);
mux032 fin3(32'b00000000000000000000000000000000,zz81,~lcont,o3);
